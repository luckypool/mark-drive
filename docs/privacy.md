...
ただし、アクセス解析のために Google Analytics へ匿名の利用データ（ページビュー、機能の利用状況、デバイス情報等）が送信されます。詳細は「サードパーティサービス > アクセス解析」を参照してください。
...
| サービス | 用途 | プライバシーポリシー |
|---------|------|---------------------|
| Google Analytics | アクセス解析（ページビュー・機能利用状況等） | [Google プライバシーポリシー](https://policies.google.com/privacy) |

MarkDrive はサービス改善のために Google Analytics を使用し、以下の匿名データを収集します:

- ページビュー
- 機能の利用状況（ログイン、ファイルを開く、PDF出力などの操作イベント）
- おおよその地域情報
- デバイス・ブラウザの種類
